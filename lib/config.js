...
module.exports = (function () {
  ...
  return {
    ...
    validate: function () {
      ...
      if (!config.features.markitup && !config.features.codemirror && !config.features.bootstrapMarkdown) {
        config.features.bootstrapMarkdown = true;
      }

      if (config.features.bootstrapMarkdown && (config.features.markitup || config.features.codemirror)) {
        config.features.markitup = false;
        config.features.codemirror = false;
      }
